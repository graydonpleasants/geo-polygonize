...
|---|---|---|---|---|---|---|
| 5 | 0.000182 | 0.000698 | 0.002610 | 3.83x | 0.27x | 14.34x |
| 10 | 0.000399 | 0.002203 | 0.001330 | 5.53x | 1.66x | 3.34x |
| 20 | 0.001042 | 0.008160 | 0.003380 | 7.83x | 2.41x | 3.24x |
| 50 | 0.004320 | 0.051835 | 0.011160 | 12.00x | 4.64x | 2.58x |
| 100 | 0.016247 | 0.231354 | 0.029750 | 14.24x | 7.78x | 1.83x |

### Random Lines

| Count | Rust Time (s) | Python Time (s) | Wasm Time (s) | Speedup (Py/Rs) | Speedup (Py/Wasm) | Speedup (Wasm/Rs) |
|---|---|---|---|---|---|---|
| 50 | 0.000932 | 0.008100 | 0.001070 | 8.69x | 7.57x | 1.15x |
| 100 | 0.003065 | 0.025878 | 0.003790 | 8.44x | 6.83x | 1.24x |
| 200 | 0.010883 | 0.104309 | 0.015440 | 9.58x | 6.76x | 1.42x |
